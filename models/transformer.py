...
def get_model(args : argparse.ArgumentParser, vocab_src_len, vocab_tgt_len):
    model = build_transformer(vocab_src_len, vocab_tgt_len, int(args.seq_len), int(args.seq_len), d_model=int(args.embed_size))
    return model
